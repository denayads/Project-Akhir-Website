            ...
            <div class="row g-3">
                    ...
                    <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="<%=ResolveUrl("~/assets/img/Cyberpunk2077_1.jpg")%>" class="img-fluid w-100 rounded" style="opacity: 0.5;">
                            ...
                            <div class="carousel-item">
                                <img src="<%=ResolveUrl("~/assets/img/ResidentEvil4_1.jpg")%>" class="img-fluid w-100 rounded" style="opacity: 0.5;">
                                <div class="carousel-caption">
                                    <div class="p-3">
                            ...
                            <div class="carousel-item">
                                <img src="<%=ResolveUrl("~/assets/img/AlanWake2_1.jpg")%>" class="img-fluid w-100 rounded" style="opacity: 0.5;">
                                <div class="carousel-caption">
                                    <div class="p-3">
                            ...
                            <div class="carousel-item">
                                <img src="<%=ResolveUrl("~/assets/img/MarvelsSpiderMan2_1.jpg")%>" class="img-fluid w-100 rounded" style="opacity: 0.5;">
                                <div class="carousel-caption">
                ...
                <div class="col-2">
                    <div class="row g-2 mb-2" data-bs-target="#carouselId" data-bs-slide-to="0">
                        <div class="col-6">
                            <img src="<%=ResolveUrl("~/assets/img/Cyberpunk2077_1.jpg")%>" class="img-fluid img-thumbnail rounded" style="object-fit: cover; min-height: 100px;">
                        </div>
                    ...
                    <div class="row g-2 mb-2" data-bs-target="#carouselId" data-bs-slide-to="1">
                        <div class="col-6">
                            <img src="<%=ResolveUrl("~/assets/img/ResidentEvil4_1.jpg")%>" class="img-fluid img-thumbnail rounded" style="object-fit: cover; min-height: 100px;">
                        </div>
                        <div class="col-6 align-self-center">
                    ...
                    <div class="row g-2 mb-2" data-bs-target="#carouselId" data-bs-slide-to="2">
                        <div class="col-6">
                            <img src="<%=ResolveUrl("~/assets/img/AlanWake2_1.jpg")%>" class="img-fluid img-thumbnail rounded" style="object-fit: cover; min-height: 100px;">
                        </div>
                        <div class="col-6 align-self-center">
                    ...
                    <div class="row g-2 mb-2" data-bs-target="#carouselId" data-bs-slide-to="3">
                        <div class="col-6">
                            <img src="<%=ResolveUrl("~/assets/img/MarvelsSpiderMan2_1.jpg")%>" class="img-fluid img-thumbnail rounded" style="object-fit: cover; min-height: 100px;">
                        </div>
                        <div class="col-6 align-self-center">
